...
Whereas the following raw text.[^markdown_narrative-1]

[^markdown_narrative-1]: This is a footnote and is defined by enclosing square brackets and a carat symbol (\^) where you want to put the footnote in the text (e.g., \[\^1\]) and then at the bottom of the document add the text (this part) prepended by \[\^1\]:. The linking to the footnote and back to the place you put it will be automagically inserted.
